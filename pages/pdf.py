...
st.set_page_config(page_title="PROMPT GENIE for PDF 💬", page_icon="💬")
st.title("PROMPT GENIE for PDF 💬")
...
with st.sidebar:
    ...
    model_selection = st.selectbox(
        "LLM 선택", ["exaone-3.8B:latest", "EEVE-Korean-10.8B:latest", "gpt-4o", "gpt-4-turbo", "gpt-4o-mini", "gpt-3.5-turbo"]
    )
